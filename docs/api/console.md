...
This page contains curl examples for the gateway. Replace `{BASE_URL}` and
...
### 1. Add task
```console
curl --http3 -X POST "{BASE_URL}/add_task" \
...
```console
curl --http3 "{BASE_URL}/get_status?id=123e4567-e89b-12d3-a456-426614174000" \
     -H "x-api-key: {YOUR-API-KEY}"
```
...
```console
curl --http3 "{BASE_URL}/get_result?id=123e4567-e89b-12d3-a456-426614174000" \
     -H "x-api-key: {YOUR-API-KEY}" \
     -o result.spz
```
...
```console
curl --http3 "{BASE_URL}/get_result?id=123e4567-e89b-12d3-a456-426614174000&compress=0" \
     -H "x-api-key: {YOUR-API-KEY}" \
     -o model.ply
```
